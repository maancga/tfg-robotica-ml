...
echo_and_run cd "/home/manu/catkin_ws/src/turtlebot/turtlebot_create/create_node"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/manu/catkin_ws/src/turtlebot/turtlebot_create/create_node/setup.py" \
     \
    build --build-base "/home/manu/catkin_ws/build/turtlebot/turtlebot_create/create_node" \
    install \
    --root="${DESTDIR-/}" \
